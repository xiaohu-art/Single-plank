...
class RaibertSwingLegController(leg_controller.LegController):
  ...
  def get_action(self) -> Mapping[Any, Any]:
    ...
    # print(f"hip positions: {hip_positions}")
    # hip positions: ((0.17, -0.135, 0), (0.17, 0.13, 0), (-0.195, -0.135, 0), (-0.195, 0.13, 0))
    hip_positions = ((0.17, -0.03, 0), (0.17, 0.03, 0), (-0.195, -0.03, 0), (-0.195, 0.03, 0))
